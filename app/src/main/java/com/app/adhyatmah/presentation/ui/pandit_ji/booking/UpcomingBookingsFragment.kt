...
import com.app.adhyatmah.databinding.FragmentUpcomingBookingsBinding
...
class UpcomingBookingsFragment : BaseFragment<FragmentUpcomingBookingsBinding>() {

    private val viewModel: BookingViewModel by viewModels()
    private lateinit var previousBookingAdapter: PreviousBookingAdapter

    override fun setLayout(): Int = R.layout.fragment_upcoming_bookings
    ...
    private fun observeBookings() {
        viewModel.getBookings().observe(viewLifecycleOwner) { resource ->
            when (resource.status) {
                ...
                Status.ERROR -> {
                    ProcessDialog.dismissDialog(true)
                    Log.e("UpcomingBookingsFragment", "Error: ${resource.message}")
                }
