...
//                binding.firstName.error = "Please enter your first name"
             //   Toast.makeText(requireActivity(), "Please enter your first name", Toast.LENGTH_SHORT).show()
                Toast.makeText(requireActivity(), "Please enter your valid first name", Toast.LENGTH_SHORT).show()
                Toast.makeText(requireActivity(), "Please enter your first name", Toast.LENGTH_SHORT).show()
...
//                binding.etLastName.error = "Please enter your last name"
                Toast.makeText(requireActivity(), "Please enter your last name", Toast.LENGTH_SHORT).show()
...
//                binding.etPassword.error = "Password must be at least 6 characters"
            ...
            val request = SignUpRequest(firstName, lastName, email, password, phone = phone, role = role, deviceType = "android", deviceToken = fcmToken)
    ...
    fun privacyPolicy() {
        ...
        val fullText = getString(R.string.by_signing_up_you_agree_to_our_terms_of_services_and_privacy_policy)
        ...
        if (startTerms >= 0 && endTerms <= fullText.length) {
            val termsSpan = object : ClickableSpan() {
                override fun onClick(widget: View) {
                    ...
                    findNavController().navigate(R.id.action_signUpFragment_to_termConditionFragment,bundle)
            ...
            spannableString.setSpan(termsSpan, startTerms, endTerms, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        }
...
//                    Toast.makeText(requireContext(), "$privacy clicked", Toast.LENGTH_SHORT).show()
            ...
            spannableString.setSpan(privacySpan, startPrivacy, endPrivacy, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        }
...
*/
                            Toast.makeText(requireActivity(), "Account created to successfully", Toast.LENGTH_SHORT).show()
                ...
                Status.SUCCESS -> {
                    ...
                    when (statusCode) {
                        200 -> {
                            ...
                            Preferences.setStringPreference(requireContext(), IS_LOGIN, "1")
                            Preferences.setCustomModelPreference(requireContext(), IS_PROFILE_DATA,payload)
